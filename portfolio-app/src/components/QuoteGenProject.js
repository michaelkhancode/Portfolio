    ...
    <div className="contentWrapper">
      <div className="flexWrapper" >
          ...
          <div className="projectImage">     
            <a
            target="_blank" 
            href="https://codepen.io/Mike-yoh/full/YQNoWr/"
            >
            <img 
            className="grow"
            width="600px"
            ...
            src="https://i.imgur.com/WvEGmBe.png" 
            alt=""/>
            </a>
          </div>
          <div>
            ...
            <h2>How To Use</h2>
            <p >
              Click the button and generate an inspirational, thought provoking quote.
            </p>
          </div>
          <div>
...
export default QuoteGenProject;